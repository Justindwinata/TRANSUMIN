...
class _FakeHistoryPersistence implements HistoryPersistence {
  ...
  @override
  Future<void> save(List<JourneyHistoryEntry> entries) async => stored = List.from(entries);
  @override
...
void main() {
  group('Integration flow - save and replan', () {
    ...
    test('search -> save history -> history persisted -> saved journey payload valid', () async {
      ...
      historyNotifier.addEntry(JourneyHistoryEntry(
        id: 'search-1',
        originName: 'Home',
        destName: 'Office',
