...
final routePreferenceProvider = StateNotifierProvider<RoutePreferenceNotifier, RoutePreference>((ref) {
  return RoutePreferenceNotifier(ref.read(userPreferencesRepositoryProvider));
});
